...
//  RSA加密
//
//  Created by lihongfeng on 16/4/20.
...
//
//    //使用字符串格式的公钥私钥加密解密
//    NSString *encryptStr = [RSAEncryptor encryptString:originalString publicKey:@"MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDNnglzqeU5M90ZgPD8eXAwj0cSWoKtq0ZNE/tkO2ozh6f6rNEb+vU+rcXi7mFKIb5TTIadpEVpnhCx/tKJdhOIcY/yWuAPX3zD/m8IILi08QH943vSbedoBigCj8OlsSkI8spZZI1n84ODfDLaaiHsqyqi1W6AysABU7M5i1iCGwIDAQAB"];
//
//    NSLog(@"加密前:%@", originalString);
//    NSLog(@"加密后:%@", encryptStr);
